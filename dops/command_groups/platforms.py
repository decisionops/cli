...
def register_platform_commands(subparsers: argparse._SubParsersAction[argparse.ArgumentParser], supported_platform_ids: list[str]) -> None:
    ...
    add_examples(platform_parser, ["dops platform list", "dops platform build --platform codex --output-dir build"])
